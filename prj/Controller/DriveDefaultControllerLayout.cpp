...
void DriveDefaultControllerLayout::checkState(uint8_t button) {
...
void DriveDefaultControllerLayout::setVelocity(int X, int Y) {
    if (stateManager)
...
void DriveDefaultControllerLayout::setAngularVelocity(int X, int Y) {
    if (stateManager)
        driveState = stateManager->getState();
...
void DriveDefaultControllerLayout::incrementMaxSpeed(int val) {
    if (stateManager)
        driveState = stateManager->getState();
...
void DriveDefaultControllerLayout::buttonResponse(uint8_t buttonID) {
...
void DriveDefaultControllerLayout::leftStickResponse(int xValue, int yValue) {
    setVelocity(xValue, yValue);
}

void DriveDefaultControllerLayout::rightStickResponse(int xValue, int yValue) {
