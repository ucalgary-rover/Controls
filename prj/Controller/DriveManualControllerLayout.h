...
public:
    DriveManualControllerLayout(DriveMotorStateManager* driveStateManager) :
        ...
        REGISTER_BUTTON(buttonCallbacks, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, decrementWheelOnce);
        REGISTER_BUTTON(buttonCallbacks, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, incrementWheelOnce);
...
private:
    ...
    // helper functions
    void triggerToincrementWheelValue(int triggerVal, float increment);
